  ...
  <div class="container">
          ...
          <tr v-for="(genre, index) in genres" :key="genre.id">
            ...
            <td>
              <div class="action-btns">
                <RouterLink :to="'/edit-genre/' + genre.id" class="btn-action btn-edit">
                  ✏️ Edit
                </RouterLink>
                <button
    ...
    <div v-if="showModal" class="modal-overlay" @click.self="showModal = false">
      <div class="modal-box">
        ...
        <p>Yakin ingin menghapus genre:</p>
        <p class="modal-film-name">❝ {{ genreToDelete?.nama_genre }} ❞</p>
...
const konfirmasiHapus = async () => {
  ...
  try {
    ...
    alert('Gagal menghapus genre! ' + (err.response?.data?.message || ''))
    console.error(err)
  } finally {
